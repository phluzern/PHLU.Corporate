...
class RegistrationButtonViewHelper extends AbstractViewHelper
{
    ...
    public function render($url, $identifier)
    {
        ...
        if (substr_count($url,"iframe.phlu.ch")) {
            ...
            $html .= '<script>jQuery(\'#iframe'.$hash.'\').iFrameResize({checkOrigin:false, heightCalculationMethod: \'bodyScroll\'}); function iframe'.$hash.'(self) {jQuery(\'<div class="close-iframe"><a class="btn btn-primary" href="#"><span class="oi oi-x"></span></a></div>\').insertBefore(self);jQuery(self).parentsUntil(\'col-md-5\').removeClass(\'col-md-5\');jQuery(self).hide();jQuery(\'#iframe'.$hash.'\').show();jQuery(\'#iframe'.$hash.'\').get(0).iFrameResizer.resize();jQuery(\'.close-iframe a\').on(\'click\',function(){$(this).parent().parent().find(\'iframe\').css({height: \'1px\',display:\'none\'});$(this).closest(\'.col-sm-12\').addClass(\'col-md-5\');$(this).parent().parent().find(\'.btn-primary\').css(\'display\',\'block\');$(this).parent().hide();});}</script>';
