...
class ImageViewHelper extends AbstractViewHelper
{
     ...
     * @param boolean $relativeUri
     * @return string the relative image path, to be used as src attribute for <img /> tags
     */
    public function render(ImageInterface $image = null, $width = null, $maximumWidth = null, $height = null, $maximumHeight = null, $allowCropping = false, $allowUpScaling = false, $async = false, $preset = null, $relativeUri = false)
    {
        if ($image === null) {
            return '';
        }
        ...
        if ($relativeUri) {
            $relUrl = parse_url($this->assetService->getThumbnailUriAndSizeForAsset($image, $thumbnailConfiguration, $this->controllerContext->getRequest())['src']);
            return $relUrl['path'];
        } else {
